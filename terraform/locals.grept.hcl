locals {
  ...
  # Azure/xxx
  github_repository_name = env("OVERRIDE_GITHUB_REPOSITORY") != "" ? env("OVERRIDE_GITHUB_REPOSITORY") : env("GITHUB_REPOSITORY"))
  # Azure
  github_repository_owner              = env("OVERRIDE_GITHUB_REPOSITORY_OWNER") != "" ? env("OVERRIDE_GITHUB_REPOSITORY_OWNER") : env("GITHUB_REPOSITORY_OWNER")
